...
const Contact = () => {
	return (
		<motion.div
			...
			id='kontakt'>
			<h2 className='w-full text-center text-4xl font-bold'>Contact</h2>
			<div className='flex flex-col gap-8 leading-7 lg:flex-row lg:gap-6'>
				...
				<div className='lg:flex-5 flex flex-col gap-4 px-2 lg:gap-6'>
					<h3 className='text-2xl font-bold'>Other contact methods:</h3>
					...
					<div className='flex flex-col'>
						...
						<Link
							href='https://github.com/mateuszmanczak04'
							className='flex items-center gap-1 underline'
							target='_blank'>
							<span>Go to profile</span>
							<SquareArrowOutUpRight className='h-4 w-4' />
