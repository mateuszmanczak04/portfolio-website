  ...
  return (
    <Form {...form}>
      <form
        ...
        className='flex-1 p-8 bg-white shadow-lg rounded-xl space-y-4'>
        <FormField
        ...
        <div className='grid grid-cols-1 gap-2'>
          ...
          {attachmentsError && (
            <p className='text-destructive bg-destructive/10 h-10 p-2 mt-2 rounded-md text-center'>
              {attachmentsError}
            </p>
          )}
        </div>
        ...
        {submitResult?.error && (
          <p className='text-destructive bg-destructive/10 h-10 p-2 rounded-md text-center'>
            {submitResult.error}
          </p>
        )}
        {submitResult?.success && (
          <p className='text-green-600 bg-green-100 p-2 h-10 rounded-md text-center'>
            {submitResult.success}
          </p>
        )}
      </form>
